...
public class StringCache {
     ...
     * @return the total advance (horizontal foodtower) of this string
     ...
     * @return the advance (horizontal foodtower) of this string plus the advance passed in as an argument
